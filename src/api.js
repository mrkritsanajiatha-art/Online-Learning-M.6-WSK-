...
/* ============================================================
   ...
   ============================================================ */
/* บันไดรางวัลไล่จากมากไปน้อย 40/30/25/20/15/10/5 + ช่องหมุนฟรี
   เรียงสลับมาก-น้อยรอบวง ช่องใหญ่จึงไม่ติดกัน วงล้อดูสมดุลและลุ้นกว่า
   รวม 145 XP / 7 ช่องที่จ่าย = เฉลี่ย ~20.7 XP ต่อรอบที่นับ */
export const SPIN_SEGMENTS = [
  { xp: 40 }, { xp: 10 }, { xp: 25 }, { xp: 5 },
  { free: true }, { xp: 30 }, { xp: 15 }, { xp: 20 }
];
export const SPIN_MAX_ROUNDS = 5;
export const SPIN_MAX_PRIZE = 40;         // ช่องที่จ่ายสูงสุด — ใช้เป็น max_score ของแถว
...
/* ไม่มีเพดาน XP รายวันแยกต่างหาก เพราะจำนวนรอบคุมเพดานอยู่แล้ว:
   5 รอบ x ช่องสูงสุด 40 XP = 200 XP/วัน คือค่าสูงสุดที่เป็นไปได้
